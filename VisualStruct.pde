...
class Group extends Graphic {
  ...
  Group fontAlign(int a, int b){if (font==null) font=newFont(); font.align(a,b); return this;}
...
class Font {
  ...
  private int text_align_h;
  private int text_align_v;
  ...
  Font align(int a, int b){text_align_h=a; text_align_v=b; return this;}
